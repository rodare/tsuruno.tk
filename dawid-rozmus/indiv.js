...
var myName = "Dawid Rozmus"
function memberName(){
    document.write(myName);
}

function memberEmail(){
    document.write("dawid8rozmus@gmail.com");
}

function memberShare(){
    document.write("I can share my knowledge on programming, nature, cooking and some winter sports.");
}

function memberLike(){
    document.write("I like sports, primitive technological projects, piano, guitar and singing, outdoor activities with friends, among others.");
}

function memberWant(){
    document.write("Generally I want to build strong ties with my friends. Regarding knowledge and skills, I would like to get better at skiing, japanese language, calisthenics, primitive technologies, among others.");
}
...
// var arr=["hey","perrito","quiuvo",2,4,3]
...
// let name = document.getElementById("memberName").innerHTML = "Milko Grozeb";
